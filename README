...
## 🧟 Level 4 — Shared Repo: Horde Mode  

Expand the repo into a **mass-combat playground**. Tasks could include:  

- Add **special attack/ultimate** (spin slash, ground slam, magic burst).  
- Create **enemy wave spawner** (progressive difficulty).  
- Add **enemy types** (fast swarm, tank, ranged).  
- Implement **combo chaining system**.  
- Add **polish**: hit sparks, trails, slow-motion on finishing blows.  
- Create a **pickup system** (switch weapons mid-game).  
- Add **VFX pooling** for performance.  

---

## 📌 Flow Recap  

- **Level 1**: Character moves.  
- **Level 2**: Character wields weapon (Animator + collisions + juice).  
- **Mini-project**: Show your weapon in action.  
- **Level 3**: Contribute weapon to shared Armory.  
- **Level 4**: Expand into Horde Mode (enemies, waves, combos, juice).  
